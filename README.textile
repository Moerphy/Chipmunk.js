...
Currently most of the API is ported. As far as I know off the top of my head the only gaps are in Constraints (pretty much nothing done) and Spatial Indexing (only SpatialHash done).
